...
function formatarData(data) {
    ...
    const textoGerado = `O COMANDANTE DO 11º BATALHÃO DE POLÍCIA MILITAR DO ESTADO DA PARAÍBA no exercício de suas competências e com fulcro no art. 134 da Lei Estadual (PB) nº 3.909 de 14 de julho de 1977, que dispõe sobre o “Estatuto dos Policiais Militares do Estado da Paraíba” c/c art. 23, inciso XVII e XLIX, do Regulamento Interno de Serviço Gerais (RISG) do Exército Brasileiro; e em respeito ao que estabelece o art. 5º, § 1º, item 4., do Regulamento de Movimentação para Oficiais e Praças da PMPB, aprovado pelo Decreto Estadual (PB) nº 9.143 de 08 de setembro de 1981, e inciso IV do art. 5º da NORMA GERAL DE AÇÃO – NGA Nº 001/2023-GC/11º BPM publicada no Boletim do CPR I nº 0041 de 01/03/2023, RESOLVE:

DESIGNAR, o(s) militar(es) referenciado(s), lotado no 11º BPM, na Função de Motorista Operacional na viatura prefixo ${prefixo} ${modelo} (${placa}).
...
DISPENSAR, o(s) militar(es) referenciado(s), lotado no 11º BPM, da Função de Motorista Operacional na viatura prefixo ${prefixo} ${modelo} (${placa}).
